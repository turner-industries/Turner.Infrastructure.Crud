...
namespace Turner.Infrastructure.Crud.Configuration
{
    ...
    {
        //public static CrudRequestEntityConfigBuilderCommon<TRequest, TEntity> UpdateAllWith<TRequest, TEntity, TIn, TKey>(
        //    this CrudRequestEntityConfigBuilderCommon<TRequest, TEntity> config,
        ...
        //    return config.UpdateWith(lambda);
        //}

        //public static CrudRequestEntityConfigBuilderCommon<TRequest, TEntity> UpdateAllWith<TRequest, TEntity, TIn>(
        //    this CrudRequestEntityConfigBuilderCommon<TRequest, TEntity> config,
        //    Expression<Func<TRequest, IEnumerable<TIn>>> requestEnumerableExpr,
