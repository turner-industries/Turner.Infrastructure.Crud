...
namespace Turner.Infrastructure.Crud.Tests.RequestTests
{
    ...
    public class SaveUserWithoutResponseProfile : CrudRequestProfile<SaveUserWithoutResponseRequest>
    {
        ...
        {
            ForEntity<User>()
                .SelectWith(builder => builder.Build(r => r.Id, e => e.Id))
        ...
        : CrudRequestProfile<SaveRequest<User, UserGetDto>>
    {
        ...
        {
            ForEntity<User>()
                .SelectWith(builder => builder.Build(r => e => r.Data.Id == e.Id));
        ...
        : CrudRequestProfile<SaveRequest<User, UserGetDto, UserGetDto>>
    {
        ...
        {
            ForEntity<User>()
                .SelectWith(builder => builder.Build(request => entity => request.Data.Id == entity.Id));
        }
    }
}